    // class COTPVASOL
    export class COTPVASOL {
        constructor() {
        }

        public PVASOL_CONSEC: number;
        public PVASOL_CODIGO: string;
        public PVASOL_DESCRI: string;
        public PVASOL_TIPOBIE: string;
        public PVASOL_VALMIN: number;
        public PVASOL_VALMAX: number;
        public BIEN: string;
