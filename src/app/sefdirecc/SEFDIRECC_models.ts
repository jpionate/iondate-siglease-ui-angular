    // class SETHOMODIR
    export class SETHOMODIR {
        constructor() {
        }

        public HOMODIR_DES: string;
        public HOMODIR_RUNT: string;
        public HOMODIR_DANE: string;
        public HOMODIR_COD: string;
        public HOMODIR_TIPO: string;


    }

    // class BLOCK12
    export class BLOCK12 {
        constructor() {
        }
