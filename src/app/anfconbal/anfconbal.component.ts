...
// Namespace ANFCONBAL business logic
import {
    ANTBALXTER_10,
    TOOLBAR,
    ANTBALXTER,
    ...
    ANTBALXTER_9,
    ANTBALXTER_8
} from "./ANFCONBAL_models";



// class ANFCONBAL
@Component({
    selector: 'app-anfconbal',
    templateUrl: './anfconbal.component.html',
})
export class AnfconbalComponent {
    ...
    // --; END;
    //#endregion
    async ANFCONBAL_onClearDetails() {
        console.log("Entering ANFCONBAL_onClearDetails");
        // ANFCONBAL_CLEAR_ALL_MASTER_DETAILS();
        console.log("Exiting ANFCONBAL_onClearDetails");
    }

    async ANFCONBAL_keyNxtblk() {
        // null;
    }
    ...
    //#endregion
    async ANFCONBAL_whenMouseDoubleclick() {
        console.log("Entering ANFCONBAL_whenMouseDoubleclick");
        this.oracleFormsBuiltins.list_values();
        console.log("Exiting ANFCONBAL_whenMouseDoubleclick");
    }

    async ANFCONBAL_keyCrerec() {
        // null;
    }
    ...
    // END;
    // -------------------------------------------------------
    //   IF :this.PARAMETER.get("TER_CTRL") = 'Q' THEN
    //       EXECUTE_QUERY;
    //   ELSIF :this.PARAMETER.get("TER_CTRL") IS NULL THEN
    //     ENTER_QUERY;
    //   END IF; END;
    //#endregion
    async ANFCONBAL_whenNewFormInstance() {
        console.log("Entering ANFCONBAL_whenNewFormInstance");
        ...
        this.BASE.BASE_DAT = PLSQLBuiltins.upper(this.BASE.BD);
        {
            ...
            if ((this.PARAMETER.get("P_OFICINA") != null)) {
                ...
                // call REST API
                const result1 = await Rest.post("/anfconbal/anfconbal_whennewforminstance_query1", payload1);
        ...
        if (this.PARAMETER.get("TER_CTRL") == "Q") {
            this.oracleFormsBuiltins.execute_query();
        }
        else if ((this.PARAMETER.get("TER_CTRL") == null)) {
            this.oracleFormsBuiltins.enter_query();
        }
        console.log("Exiting ANFCONBAL_whenNewFormInstance");
    }
    ...
    // END;
    //#endregion
    async ANFCONBAL_preForm() {
        console.log("Entering ANFCONBAL_preForm");
        // ANFCONBAL_PANTALLA();
        // ANFCONBAL_PINCIARSGRDADOFCNAS();
        console.log("Exiting ANFCONBAL_preForm");
    }
    ...
    // END;
    //#endregion
    async ANFCONBAL_keyUp() {
        console.log("Entering ANFCONBAL_keyUp");
        if (this._SYSTEM_SERVICE.get("TRIGGER_RECORD") > "1") {
            this.oracleFormsBuiltins.up();
        }
        console.log("Exiting ANFCONBAL_keyUp");
    }
    ...
    // END;
    //#endregion
    async ANFCONBAL_keyExit() {
        console.log("Entering ANFCONBAL_keyExit");
        ...
        console.log("Exiting ANFCONBAL_keyExit");
    }

    async ANFCONBAL_keyPrvblk() {
        // null;
    }
    ...
    // END;
    //#endregion
    async ANFCONBAL_keyDown() {
        console.log("Entering ANFCONBAL_keyDown");
        if (this.oracleFormsBuiltins.get("last_record") == "FALSE") {
            this.oracleFormsBuiltins.down();
        }
        console.log("Exiting ANFCONBAL_keyDown");
    }
    ...
    // END;
    //#endregion
    async ANFCONBAL_antbalxter10_postQuery() {
        console.log("Entering ANFCONBAL_antbalxter10_postQuery");
        // construct payload
        let payload1 = new Map();
        payload1.set("BAXTER_CODCTA", this.ANTBALXTER_10.BAXTER_CODCTA);
        // call REST API
        const result1 = await Rest.post("/anfconbal_antbalxter_10/anfconbal_antbalxter10_postquery_query1", payload1);
        // get values from result
        ...
        console.log("Exiting ANFCONBAL_antbalxter10_postQuery");
    }
    ...
    //#endregion
    async ANFCONBAL_antbalxter10_calculadora10_keyNextItem() {
        console.log("Entering ANFCONBAL_antbalxter10_calculadora10_keyNextItem");
        ...
        console.log("Exiting ANFCONBAL_antbalxter10_calculadora10_keyNextItem");
    }
    ...
    // HIDE_VIEW('CANVAS14'); END;
    //#endregion
    async ANFCONBAL_antbalxter10_calculadora10_keyHelp() {
        console.log("Entering ANFCONBAL_antbalxter10_calculadora10_keyHelp");
        this.oracleFormsBuiltins.go_item("ANTBALXTER_10.BAXTER_VALORC");
        this.oracleFormsBuiltins.hide_view("CANVAS14");
        console.log("Exiting ANFCONBAL_antbalxter10_calculadora10_keyHelp");
    }

    //#region PLSQL
    // BEGIN TOOLBAR_ACTIONS; END;
    //#endregion
    async ANFCONBAL_toolbar_whenButtonPressed() {
        console.log("Entering ANFCONBAL_toolbar_whenButtonPressed");
        // ANFCONBAL_TOOLBAR_ACTIONS();
        console.log("Exiting ANFCONBAL_toolbar_whenButtonPressed");
    }
    ...
    // END;
    //#endregion
    async ANFCONBAL_toolbar_whenMouseLeave() {
        console.log("Entering ANFCONBAL_toolbar_whenMouseLeave");
        // ANFCONBAL_DEL_TIMER("BUBBLE_DELAY");
        this.oracleFormsBuiltins.set_item_property("TOOLBAR.BUTTON_HELP", "DISPLAYED", "PROPERTY_OFF");
        console.log("Exiting ANFCONBAL_toolbar_whenMouseLeave");
    }
    ...
    // END;
    //#endregion
    async ANFCONBAL_toolbar_whenNewFormInstance() {
        console.log("Entering ANFCONBAL_toolbar_whenNewFormInstance");
        this.oracleFormsBuiltins.execute_query();
        this.oracleFormsBuiltins.next_block();
        this.oracleFormsBuiltins.enter_query();
        console.log("Exiting ANFCONBAL_toolbar_whenNewFormInstance");
    }
    ...
    // END;
    //#endregion
    async ANFCONBAL_antbalxter_postQuery() {
        console.log("Entering ANFCONBAL_antbalxter_postQuery");
        // construct payload
        let payload1 = new Map();
        payload1.set("BAXTER_CODCTA", this.ANTBALXTER.BAXTER_CODCTA);
        // call REST API
        const result1 = await Rest.post("/anfconbal_antbalxter/anfconbal_antbalxter_postquery_query1", payload1);
        // get values from result
        ...
        // call REST API
        const result2 = await Rest.post("/anfconbal_antbalxter/anfconbal_antbalxter_postquery_query2", payload2);
        // get values from result
        ...
        console.log("Exiting ANFCONBAL_antbalxter_postQuery");
    }
    ...
    //#endregion
    async ANFCONBAL_antbalxter_calculadora_keyNextItem() {
        console.log("Entering ANFCONBAL_antbalxter_calculadora_keyNextItem");
        ...
        console.log("Exiting ANFCONBAL_antbalxter_calculadora_keyNextItem");
    }
    ...
    // HIDE_VIEW('CANVAS4'); END;
    //#endregion
    async ANFCONBAL_antbalxter_calculadora_keyHelp() {
        console.log("Entering ANFCONBAL_antbalxter_calculadora_keyHelp");
        this.oracleFormsBuiltins.go_item("ANTBALXTER.BAXTER_VALORC");
        this.oracleFormsBuiltins.hide_view("CANVAS4");
        console.log("Exiting ANFCONBAL_antbalxter_calculadora_keyHelp");
    }
    ...
    // END;
    //#endregion
    async ANFCONBAL_antbalxter7_postQuery() {
        console.log("Entering ANFCONBAL_antbalxter7_postQuery");
        // construct payload
        let payload1 = new Map();
        payload1.set("BAXTER_CODCTA", this.ANTBALXTER_7.BAXTER_CODCTA);
        // call REST API
        const result1 = await Rest.post("/anfconbal_antbalxter_7/anfconbal_antbalxter7_postquery_query1", payload1);
        // get values from result
        ...
        console.log("Exiting ANFCONBAL_antbalxter7_postQuery");
    }
    ...
    //#endregion
    async ANFCONBAL_antbalxter7_calculadora7_keyNextItem() {
        console.log("Entering ANFCONBAL_antbalxter7_calculadora7_keyNextItem");
        ...
        console.log("Exiting ANFCONBAL_antbalxter7_calculadora7_keyNextItem");
    }
    ...
    // HIDE_VIEW('CANVAS11'); END;
    //#endregion
    async ANFCONBAL_antbalxter7_calculadora7_keyHelp() {
        console.log("Entering ANFCONBAL_antbalxter7_calculadora7_keyHelp");
        this.oracleFormsBuiltins.go_item("ANTBALXTER_7.BAXTER_VALORC");
        this.oracleFormsBuiltins.hide_view("CANVAS11");
        console.log("Exiting ANFCONBAL_antbalxter7_calculadora7_keyHelp");
    }
    ...
    // END;
    //#endregion
    async ANFCONBAL_antbalxter6_postQuery() {
        console.log("Entering ANFCONBAL_antbalxter6_postQuery");
        // construct payload
        let payload1 = new Map();
        payload1.set("BAXTER_CODCTA", this.ANTBALXTER_6.BAXTER_CODCTA);
        // call REST API
        const result1 = await Rest.post("/anfconbal_antbalxter_6/anfconbal_antbalxter6_postquery_query1", payload1);
        // get values from result
        ...
        payload2.set("DIAXBA_CODPER", this.VARIABLE.DIAXBA_CODPER);
        // call REST API
        const result2 = await Rest.post("/anfconbal_antbalxter_6/anfconbal_antbalxter6_postquery_query2", payload2);
        // get values from result
        ...
        // call REST API
        const result3 = await Rest.post("/anfconbal_antbalxter_6/anfconbal_antbalxter6_postquery_query3", payload3);
        // get values from result
        ...
        // call REST API
        const result4 = await Rest.post("/anfconbal_antbalxter_6/anfconbal_antbalxter6_postquery_query4", payload4);
        // get values from result
        ...
        console.log("Exiting ANFCONBAL_antbalxter6_postQuery");
    }
    ...
    //#endregion
    async ANFCONBAL_antbalxter6_calculadora6_keyNextItem() {
        console.log("Entering ANFCONBAL_antbalxter6_calculadora6_keyNextItem");
        ...
        console.log("Exiting ANFCONBAL_antbalxter6_calculadora6_keyNextItem");
    }
    ...
    // HIDE_VIEW('CANVAS10'); END;
    //#endregion
    async ANFCONBAL_antbalxter6_calculadora6_keyHelp() {
        console.log("Entering ANFCONBAL_antbalxter6_calculadora6_keyHelp");
        this.oracleFormsBuiltins.go_item("ANTBALXTER_6.BAXTER_VALORC");
        this.oracleFormsBuiltins.hide_view("CANVAS10");
        console.log("Exiting ANFCONBAL_antbalxter6_calculadora6_keyHelp");
    }
    ...
    // END;
    //#endregion
    async ANFCONBAL_antbalxter5_postQuery() {
        console.log("Entering ANFCONBAL_antbalxter5_postQuery");
        // construct payload
        let payload1 = new Map();
        payload1.set("BAXTER_CODCTA", this.ANTBALXTER_5.BAXTER_CODCTA);
        // call REST API
        const result1 = await Rest.post("/anfconbal_antbalxter_5/anfconbal_antbalxter5_postquery_query1", payload1);
        // get values from result
        ...
        payload2.set("DIAXBA_CODPER", this.VARIABLE.DIAXBA_CODPER);
        // call REST API
        const result2 = await Rest.post("/anfconbal_antbalxter_5/anfconbal_antbalxter5_postquery_query2", payload2);
        // get values from result
        ...
        payload3.set("DIAXBA_CODPER", this.VARIABLE.DIAXBA_CODPER);
        // call REST API
        const result3 = await Rest.post("/anfconbal_antbalxter_5/anfconbal_antbalxter5_postquery_query3", payload3);
        // get values from result
        ...
        console.log("Exiting ANFCONBAL_antbalxter5_postQuery");
    }
    ...
    //#endregion
    async ANFCONBAL_antbalxter5_calculadora5_keyNextItem() {
        console.log("Entering ANFCONBAL_antbalxter5_calculadora5_keyNextItem");
        ...
        console.log("Exiting ANFCONBAL_antbalxter5_calculadora5_keyNextItem");
    }
    ...
    // HIDE_VIEW('CANVAS9'); END;
    //#endregion
    async ANFCONBAL_antbalxter5_calculadora5_keyHelp() {
        console.log("Entering ANFCONBAL_antbalxter5_calculadora5_keyHelp");
        this.oracleFormsBuiltins.go_item("ANTBALXTER_5.BAXTER_VALORC");
        this.oracleFormsBuiltins.hide_view("CANVAS9");
        console.log("Exiting ANFCONBAL_antbalxter5_calculadora5_keyHelp");
    }
    ...
    // END;
    //#endregion
    async ANFCONBAL_antbalxter4_postQuery() {
        console.log("Entering ANFCONBAL_antbalxter4_postQuery");
        // construct payload
        let payload1 = new Map();
        payload1.set("BAXTER_CODCTA", this.ANTBALXTER_4.BAXTER_CODCTA);
        // call REST API
        const result1 = await Rest.post("/anfconbal_antbalxter_4/anfconbal_antbalxter4_postquery_query1", payload1);
        // get values from result
        ...
        payload2.set("DIAXBA_CODPER", this.VARIABLE.DIAXBA_CODPER);
        // call REST API
        const result2 = await Rest.post("/anfconbal_antbalxter_4/anfconbal_antbalxter4_postquery_query2", payload2);
        // get values from result
        ...
        console.log("Exiting ANFCONBAL_antbalxter4_postQuery");
    }
    ...
    //#endregion
    async ANFCONBAL_antbalxter4_calculadora4_keyNextItem() {
        console.log("Entering ANFCONBAL_antbalxter4_calculadora4_keyNextItem");
        ...
        console.log("Exiting ANFCONBAL_antbalxter4_calculadora4_keyNextItem");
    }
    ...
    // HIDE_VIEW('CANVAS8'); END;
    //#endregion
    async ANFCONBAL_antbalxter4_calculadora4_keyHelp() {
        console.log("Entering ANFCONBAL_antbalxter4_calculadora4_keyHelp");
        this.oracleFormsBuiltins.go_item("ANTBALXTER_4.BAXTER_VALORC");
        this.oracleFormsBuiltins.hide_view("CANVAS8");
        console.log("Exiting ANFCONBAL_antbalxter4_calculadora4_keyHelp");
    }
    ...
    // END;
    //#endregion
    async ANFCONBAL_antbalxter3_postQuery() {
        console.log("Entering ANFCONBAL_antbalxter3_postQuery");
        // construct payload
        let payload1 = new Map();
        payload1.set("BAXTER_CODCTA", this.ANTBALXTER_3.BAXTER_CODCTA);
        // call REST API
        const result1 = await Rest.post("/anfconbal_antbalxter_3/anfconbal_antbalxter3_postquery_query1", payload1);
        // get values from result
        ...
        console.log("Exiting ANFCONBAL_antbalxter3_postQuery");
    }
    ...
    //#endregion
    async ANFCONBAL_antbalxter3_calculadora3_keyNextItem() {
        console.log("Entering ANFCONBAL_antbalxter3_calculadora3_keyNextItem");
        ...
        console.log("Exiting ANFCONBAL_antbalxter3_calculadora3_keyNextItem");
    }
    ...
    // HIDE_VIEW('CANVAS7'); END;
    //#endregion
    async ANFCONBAL_antbalxter3_calculadora3_keyHelp() {
        console.log("Entering ANFCONBAL_antbalxter3_calculadora3_keyHelp");
        this.oracleFormsBuiltins.go_item("ANTBALXTER_3.BAXTER_VALORC");
        this.oracleFormsBuiltins.hide_view("CANVAS7");
        console.log("Exiting ANFCONBAL_antbalxter3_calculadora3_keyHelp");
    }
    ...
    // END;
    //#endregion
    async ANFCONBAL_antbalxter3_baxterValorc_keyNextItem() {
        console.log("Entering ANFCONBAL_antbalxter3_baxterValorc_keyNextItem");
        if (this.ANTBALXTER_3.BAXTER_CODCTA == "1900") {
            ...
            // call REST API
            const result1 = await Rest.post("/anfconbal_antbalxter_3/anfconbal_antbalxter3_baxtervalorc_keynextitem_query1", payload1);
        }
        console.log("Exiting ANFCONBAL_antbalxter3_baxterValorc_keyNextItem");
    }
    ...
    // END;
    //#endregion
    async ANFCONBAL_antbalxter13_postQuery() {
        console.log("Entering ANFCONBAL_antbalxter13_postQuery");
        // construct payload
        let payload1 = new Map();
        payload1.set("BAXTER_CODCTA", this.ANTBALXTER_13.BAXTER_CODCTA);
        // call REST API
        const result1 = await Rest.post("/anfconbal_antbalxter_13/anfconbal_antbalxter13_postquery_query1", payload1);
        // get values from result
        ...
        payload2.set("DIAXBA_CODPER", this.VARIABLE.DIAXBA_CODPER);
        // call REST API
        const result2 = await Rest.post("/anfconbal_antbalxter_13/anfconbal_antbalxter13_postquery_query2", payload2);
        // get values from result
        ...
        console.log("Exiting ANFCONBAL_antbalxter13_postQuery");
    }
    ...
    //#endregion
    async ANFCONBAL_antbalxter13_calculadora13_keyNextItem() {
        console.log("Entering ANFCONBAL_antbalxter13_calculadora13_keyNextItem");
        ...
        console.log("Exiting ANFCONBAL_antbalxter13_calculadora13_keyNextItem");
    }
    ...
    // HIDE_VIEW('CANVAS17'); END;
    //#endregion
    async ANFCONBAL_antbalxter13_calculadora13_keyHelp() {
        console.log("Entering ANFCONBAL_antbalxter13_calculadora13_keyHelp");
        this.oracleFormsBuiltins.go_item("ANTBALXTER_13.BAXTER_VALORC");
        this.oracleFormsBuiltins.hide_view("CANVAS17");
        console.log("Exiting ANFCONBAL_antbalxter13_calculadora13_keyHelp");
    }
    ...
    // END;
    //#endregion
    async ANFCONBAL_antbalxter2_postQuery() {
        console.log("Entering ANFCONBAL_antbalxter2_postQuery");
        // construct payload
        let payload1 = new Map();
        payload1.set("BAXTER_CODCTA", this.ANTBALXTER_2.BAXTER_CODCTA);
        // call REST API
        const result1 = await Rest.post("/anfconbal_antbalxter_2/anfconbal_antbalxter2_postquery_query1", payload1);
        // get values from result
        ...
        payload2.set("DIAXBA_CODPER", this.VARIABLE.DIAXBA_CODPER);
        // call REST API
        const result2 = await Rest.post("/anfconbal_antbalxter_2/anfconbal_antbalxter2_postquery_query2", payload2);
        // get values from result
        ...
        payload3.set("DIAXBA_CODPER", this.VARIABLE.DIAXBA_CODPER);
        // call REST API
        const result3 = await Rest.post("/anfconbal_antbalxter_2/anfconbal_antbalxter2_postquery_query3", payload3);
        // get values from result
        ...
        console.log("Exiting ANFCONBAL_antbalxter2_postQuery");
    }
    ...
    //#endregion
    async ANFCONBAL_antbalxter2_calculadora2_keyNextItem() {
        console.log("Entering ANFCONBAL_antbalxter2_calculadora2_keyNextItem");
        ...
        console.log("Exiting ANFCONBAL_antbalxter2_calculadora2_keyNextItem");
    }
    ...
    // HIDE_VIEW('CANVAS6'); END;
    //#endregion
    async ANFCONBAL_antbalxter2_calculadora2_keyHelp() {
        console.log("Entering ANFCONBAL_antbalxter2_calculadora2_keyHelp");
        this.oracleFormsBuiltins.go_item("ANTBALXTER_2.BAXTER_VALORC");
        this.oracleFormsBuiltins.hide_view("CANVAS6");
        console.log("Exiting ANFCONBAL_antbalxter2_calculadora2_keyHelp");
    }

    //#region PLSQL
    // BEGIN --MANEJO DE PARAMETROS LLAMADO DESDE OTRA FORMA
    // IF  :this.PARAMETER.get("TER_CTRL") = ('Q') THEN
    // :VARIABLE.DIAXBA_CODTER := NVL(:this.PARAMETER.get("TER_NIT"),:VARIABLE.DIAXBA_CODTER) ;
    // :VARIABLE.DIAXBA_CODPER := NVL(:this.PARAMETER.get("PMAXPERIO"),:VARIABLE.this.VARIABLE.DIAXBA_CODPER);
    // END IF; END;
    //#endregion
    async ANFCONBAL_variable_preQuery() {
        console.log("Entering ANFCONBAL_variable_preQuery");
        if (this.PARAMETER.get("TER_CTRL") == "Q") {
            this.VARIABLE.DIAXBA_CODTER = this.PARAMETER.get("TER_NIT") == null ? this.VARIABLE.DIAXBA_CODTER : this.PARAMETER.get("TER_NIT");
            this.VARIABLE.DIAXBA_CODPER = this.PARAMETER.get("PMAXPERIO") == null ? this.VARIABLE.DIAXBA_CODPER : this.PARAMETER.get("PMAXPERIO");
        }
        console.log("Exiting ANFCONBAL_variable_preQuery");
    }
    ...
    // END;
    //#endregion
    async ANFCONBAL_variable_keyCrerec() {
        console.log("Entering ANFCONBAL_variable_keyCrerec");
        let T_RESPUESTA: number = null;
        let V_TACTIVO: number = null;
        let V_TPASPAT: number = null;
        let V_TUTIPAT: number = null;
        let V_TOTAPYG: number = null;
        let V_CONTADOR: number = null;
        console.log("Exiting ANFCONBAL_variable_keyCrerec");
    }
    ...
    // --; END;
    //#endregion
    async ANFCONBAL_variable_onCheckDeleteMaster() {
        console.log("Entering ANFCONBAL_variable_onCheckDeleteMaster");
        ...
        console.log("Exiting ANFCONBAL_variable_onCheckDeleteMaster");
    }
    ...
    //   END;   
    //   EXECUTE_QUERY;
    //  OPS$AUDI.PBD_AUDI_CONTROLCONSULTAS('BALANCES',:SYSTEM.LAST_QUERY,V_OPCION);
    //  COMMIT;
    // END;
    //#endregion
    async ANFCONBAL_variable_keyExeqry() {
        console.log("Entering ANFCONBAL_variable_keyExeqry");
        let T_RESPUESTA: number = null;
        ...
        try {
            ...
            // call REST API
            const result1 = await Rest.post("/anfconbal_variable/anfconbal_variable_keyexeqry_query1", payload1);
            // get values from result
        ...
        this.oracleFormsBuiltins.execute_query();
        // ANFCONBAL_OPS$AUDI.PBD_AUDI_CONTROLCONSULTAS("BALANCES", this._SYSTEM_SERVICE.get("LAST_QUERY"), V_OPCION);
        console.log("Exiting ANFCONBAL_variable_keyExeqry");
    }
    ...
    // --; END;
    //#endregion
    async ANFCONBAL_variable_onPopulateDetails() {
        console.log("Entering ANFCONBAL_variable_onPopulateDetails");
    ...
    // END;  
    //#endregion
    async ANFCONBAL_variable_postQuery() {
        console.log("Entering ANFCONBAL_variable_postQuery");
        let T_RESPUESTA: number = null;
        ...
        // call REST API
        const result1 = await Rest.post("/anfconbal_variable/anfconbal_variable_postquery_query1", payload1);
        // get values from result
        ...
        payload2.set("DIAXBA_CODPER", this.VARIABLE.DIAXBA_CODPER);
        // call REST API
        const result2 = await Rest.post("/anfconbal_variable/anfconbal_variable_postquery_query2", payload2);
        // get values from result
        ...
        payload3.set("DIAXBA_CODPER", this.VARIABLE.DIAXBA_CODPER);
        // call REST API
        const result3 = await Rest.post("/anfconbal_variable/anfconbal_variable_postquery_query3", payload3);
        // get values from result
        ...
        console.log("Exiting ANFCONBAL_variable_postQuery");
    }
    ...
    // END;
    //#endregion
    async ANFCONBAL_variable_volverPasivo_whenMouseClick() {
        console.log("Entering ANFCONBAL_variable_volverPasivo_whenMouseClick");
        ...
        this.oracleFormsBuiltins.execute_query();
        console.log("Exiting ANFCONBAL_variable_volverPasivo_whenMouseClick");
    }
    ...
    // END;
    //#endregion
    async ANFCONBAL_variable_perdidas_whenMouseClick() {
        console.log("Entering ANFCONBAL_variable_perdidas_whenMouseClick");
        ...
        this.oracleFormsBuiltins.execute_query();
        this.oracleFormsBuiltins.go_block("ANTBALXTER_8");
        console.log("Exiting ANFCONBAL_variable_perdidas_whenMouseClick");
    }
    ...
    // END;
    //#endregion
    async ANFCONBAL_variable_diaxbaDiasan_keynextitem() {
        console.log("Entering ANFCONBAL_variable_diaxbaDiasan_keynextitem");
        let T_RESPUESTA: number = null;
        let V_CONTADOR: number = null;
        ...
        this.oracleFormsBuiltins.execute_query();
        this.oracleFormsBuiltins.go_block("ANTBALXTER");
        console.log("Exiting ANFCONBAL_variable_diaxbaDiasan_keynextitem");
    }
    ...
    // END;  
    //#endregion
    async ANFCONBAL_variable_diaxbaCodter_whenValidateItem() {
        console.log("Entering ANFCONBAL_variable_diaxbaCodter_whenValidateItem");
        let T_RESPUESTA: number = null;
        let TIPTER: null = null;
        // construct payload
        let payload1 = new Map();
        payload1.set("DIAXBA_CODTER", this.VARIABLE.DIAXBA_CODTER);
        // call REST API
        const result1 = await Rest.post("/anfconbal_variable/anfconbal_variable_diaxbacodter_whenvalidateitem_query1", payload1);
        // get values from result
        this.VARIABLE.DES_NITTER = result1[0].get("DES_NITTER");
        TIPTER = result1[0].get("TIPTER");
        if (result1 == null || result1.length == 0) {

            // ANFCONBAL_LIB$ALERTA("MENSAJE", "TERCERO INEXISTENTE ...", null, null, null, T_RESPUESTA);
            console.log("FORM_TRIGGER_FAILURE");
            throw new Error('FORM_TRIGGER_FAILURE');
        }

        if (TIPTER != "J") {
            // ANFCONBAL_LIB$ALERTA("MENSAJE", "TERCERO DIFERENTE A PERSONA JURIDICA ES PERSONA NATURAL ...", null, null, null, T_RESPUESTA);
        }
        console.log("Exiting ANFCONBAL_variable_diaxbaCodter_whenValidateItem");
    }
    ...
    // END; 
    //#endregion
    async ANFCONBAL_variable_diaxbaCodper_whenValidateItem() {
        console.log("Entering ANFCONBAL_variable_diaxbaCodper_whenValidateItem");
        let T_RESPUESTA: number = null;
        let V_CONTADOR: number = null;
        V_CONTADOR = 0;
        // construct payload
        ...
        // call REST API
        const result1 = await Rest.post("/anfconbal_variable/anfconbal_variable_diaxbacodper_whenvalidateitem_query1", payload1);
        // get values from result
        this.VARIABLE.DES_PERCOD = result1[0].get("DES_PERCOD");
        if (result1 == null || result1.length == 0) {

            // ANFCONBAL_LIB$ALERTA("MENSAJE", "PERIODO INEXISTENTE ...", null, null, null, T_RESPUESTA);
            console.log("FORM_TRIGGER_FAILURE");
            throw new Error('FORM_TRIGGER_FAILURE');
        }

        console.log("Exiting ANFCONBAL_variable_diaxbaCodper_whenValidateItem");
    }
    ...
    // END;
    //#endregion
    async ANFCONBAL_variable_vPer_whenMouseClick() {
        console.log("Entering ANFCONBAL_variable_vPer_whenMouseClick");
        ...
        this.oracleFormsBuiltins.execute_query();
        console.log("Exiting ANFCONBAL_variable_vPer_whenMouseClick");
    }
    ...
    // END;
    //#endregion
    async ANFCONBAL_variable_pasivo_whenMouseClick() {
        console.log("Entering ANFCONBAL_variable_pasivo_whenMouseClick");
        let T_RESPUESTA: number = null;
        if (((this.VARIABLE.DIAXBA_CODTER == null) || (this.VARIABLE.DIAXBA_CODPER == null))) {
            // ANFCONBAL_LIB$ALERTA("MENSAJE", "EL TERCERO NO SELECCIONADO O PERIODO NO SELECCIONADO .....", null, null, null, T_RESPUESTA);
            console.log("FORM_TRIGGER_FAILURE");
            throw new Error('FORM_TRIGGER_FAILURE');
        }
        else {
        ...
        console.log("Exiting ANFCONBAL_variable_pasivo_whenMouseClick");
    }
    ...
    // END;
    //#endregion
    async ANFCONBAL_antbalxter1_postQuery() {
        console.log("Entering ANFCONBAL_antbalxter1_postQuery");
        // construct payload
        let payload1 = new Map();
        payload1.set("BAXTER_CODCTA", this.ANTBALXTER_1.BAXTER_CODCTA);
        // call REST API
        const result1 = await Rest.post("/anfconbal_antbalxter_1/anfconbal_antbalxter1_postquery_query1", payload1);
        // get values from result
        ...
        payload2.set("DIAXBA_CODPER", this.VARIABLE.DIAXBA_CODPER);
        // call REST API
        const result2 = await Rest.post("/anfconbal_antbalxter_1/anfconbal_antbalxter1_postquery_query2", payload2);
        // get values from result
        ...
        payload3.set("DIAXBA_CODPER", this.VARIABLE.DIAXBA_CODPER);
        // call REST API
        const result3 = await Rest.post("/anfconbal_antbalxter_1/anfconbal_antbalxter1_postquery_query3", payload3);
        // get values from result
        ...
        console.log("Exiting ANFCONBAL_antbalxter1_postQuery");
    }
    ...
    //#endregion
    async ANFCONBAL_antbalxter1_calculadora1_keyNextItem() {
        console.log("Entering ANFCONBAL_antbalxter1_calculadora1_keyNextItem");
        ...
        console.log("Exiting ANFCONBAL_antbalxter1_calculadora1_keyNextItem");
    }
    ...
    // HIDE_VIEW('CANVAS5'); END;
    //#endregion
    async ANFCONBAL_antbalxter1_calculadora1_keyHelp() {
        console.log("Entering ANFCONBAL_antbalxter1_calculadora1_keyHelp");
        this.oracleFormsBuiltins.go_item("ANTBALXTER_1.BAXTER_VALORC");
        this.oracleFormsBuiltins.hide_view("CANVAS5");
        console.log("Exiting ANFCONBAL_antbalxter1_calculadora1_keyHelp");
    }
    ...
    // END;
    //#endregion
    async ANFCONBAL_antbalxter11_postQuery() {
        console.log("Entering ANFCONBAL_antbalxter11_postQuery");
        // construct payload
        let payload1 = new Map();
        payload1.set("BAXTER_CODCTA", this.ANTBALXTER_11.BAXTER_CODCTA);
        // call REST API
        const result1 = await Rest.post("/anfconbal_antbalxter_11/anfconbal_antbalxter11_postquery_query1", payload1);
        // get values from result
        ...
        payload2.set("DIAXBA_CODPER", this.VARIABLE.DIAXBA_CODPER);
        // call REST API
        const result2 = await Rest.post("/anfconbal_antbalxter_11/anfconbal_antbalxter11_postquery_query2", payload2);
        // get values from result
        ...
        console.log("Exiting ANFCONBAL_antbalxter11_postQuery");
    }
    ...
    //#endregion
    async ANFCONBAL_antbalxter11_calculadora11_keyNextItem() {
        console.log("Entering ANFCONBAL_antbalxter11_calculadora11_keyNextItem");
        ...
        console.log("Exiting ANFCONBAL_antbalxter11_calculadora11_keyNextItem");
    }
    ...
    // HIDE_VIEW('CANVAS15'); END;
    //#endregion
    async ANFCONBAL_antbalxter11_calculadora11_keyHelp() {
        console.log("Entering ANFCONBAL_antbalxter11_calculadora11_keyHelp");
        this.oracleFormsBuiltins.go_item("ANTBALXTER_11.BAXTER_VALORC");
        this.oracleFormsBuiltins.hide_view("CANVAS15");
        console.log("Exiting ANFCONBAL_antbalxter11_calculadora11_keyHelp");
    }
    ...
    // END;
    //#endregion
    async ANFCONBAL_antbalxter12_postQuery() {
        console.log("Entering ANFCONBAL_antbalxter12_postQuery");
        // construct payload
        let payload1 = new Map();
        payload1.set("BAXTER_CODCTA", this.ANTBALXTER_12.BAXTER_CODCTA);
        // call REST API
        const result1 = await Rest.post("/anfconbal_antbalxter_12/anfconbal_antbalxter12_postquery_query1", payload1);
        // get values from result
        ...
        payload2.set("DIAXBA_CODPER", this.VARIABLE.DIAXBA_CODPER);
        // call REST API
        const result2 = await Rest.post("/anfconbal_antbalxter_12/anfconbal_antbalxter12_postquery_query2", payload2);
        // get values from result
        ...
        console.log("Exiting ANFCONBAL_antbalxter12_postQuery");
    }
    ...
    //#endregion
    async ANFCONBAL_antbalxter12_calculadora12_keyNextItem() {
        console.log("Entering ANFCONBAL_antbalxter12_calculadora12_keyNextItem");
        ...
        console.log("Exiting ANFCONBAL_antbalxter12_calculadora12_keyNextItem");
    }
    ...
    // HIDE_VIEW('CANVAS16'); END;
    //#endregion
    async ANFCONBAL_antbalxter12_calculadora12_keyHelp() {
        console.log("Entering ANFCONBAL_antbalxter12_calculadora12_keyHelp");
        this.oracleFormsBuiltins.go_item("ANTBALXTER_12.BAXTER_VALORC");
        this.oracleFormsBuiltins.hide_view("CANVAS16");
        console.log("Exiting ANFCONBAL_antbalxter12_calculadora12_keyHelp");
    }
    ...
    // END;
    //#endregion
    async ANFCONBAL_antbalxter9_postQuery() {
        console.log("Entering ANFCONBAL_antbalxter9_postQuery");
        // construct payload
        let payload1 = new Map();
        payload1.set("BAXTER_CODCTA", this.ANTBALXTER_9.BAXTER_CODCTA);
        // call REST API
        const result1 = await Rest.post("/anfconbal_antbalxter_9/anfconbal_antbalxter9_postquery_query1", payload1);
        // get values from result
        ...
        payload2.set("DIAXBA_CODPER", this.VARIABLE.DIAXBA_CODPER);
        // call REST API
        const result2 = await Rest.post("/anfconbal_antbalxter_9/anfconbal_antbalxter9_postquery_query2", payload2);
        // get values from result
        ...
        console.log("Exiting ANFCONBAL_antbalxter9_postQuery");
    }
    ...
    //#endregion
    async ANFCONBAL_antbalxter9_calculadora9_keyNextItem() {
        console.log("Entering ANFCONBAL_antbalxter9_calculadora9_keyNextItem");
        ...
        console.log("Exiting ANFCONBAL_antbalxter9_calculadora9_keyNextItem");
    }
    ...
    // HIDE_VIEW('CANVAS13'); END;
    //#endregion
    async ANFCONBAL_antbalxter9_calculadora9_keyHelp() {
        console.log("Entering ANFCONBAL_antbalxter9_calculadora9_keyHelp");
        this.oracleFormsBuiltins.go_item("ANTBALXTER_9.BAXTER_VALORC");
        this.oracleFormsBuiltins.hide_view("CANVAS13");
        console.log("Exiting ANFCONBAL_antbalxter9_calculadora9_keyHelp");
    }
    ...
    // END;
    //#endregion
    async ANFCONBAL_antbalxter8_postQuery() {
        console.log("Entering ANFCONBAL_antbalxter8_postQuery");
        // construct payload
        let payload1 = new Map();
        payload1.set("BAXTER_CODCTA", this.ANTBALXTER_8.BAXTER_CODCTA);
        // call REST API
        const result1 = await Rest.post("/anfconbal_antbalxter_8/anfconbal_antbalxter8_postquery_query1", payload1);
        // get values from result
        ...
        payload2.set("DIAXBA_CODPER", this.VARIABLE.DIAXBA_CODPER);
        // call REST API
        const result2 = await Rest.post("/anfconbal_antbalxter_8/anfconbal_antbalxter8_postquery_query2", payload2);
        // get values from result
        ...
        console.log("Exiting ANFCONBAL_antbalxter8_postQuery");
    }
    ...
    //#endregion
    async ANFCONBAL_antbalxter8_calculadora8_keyNextItem() {
        console.log("Entering ANFCONBAL_antbalxter8_calculadora8_keyNextItem");
        ...
        console.log("Exiting ANFCONBAL_antbalxter8_calculadora8_keyNextItem");
    }
    ...
    // HIDE_VIEW('CANVAS12'); END;
    //#endregion
    async ANFCONBAL_antbalxter8_calculadora8_keyHelp() {
        console.log("Entering ANFCONBAL_antbalxter8_calculadora8_keyHelp");
        this.oracleFormsBuiltins.go_item("ANTBALXTER_8.BAXTER_VALORC");
        this.oracleFormsBuiltins.hide_view("CANVAS12");
        console.log("Exiting ANFCONBAL_antbalxter8_calculadora8_keyHelp");
    }
