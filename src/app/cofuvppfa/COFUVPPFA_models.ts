    // class COTUVPCAM
    export class COTUVPCAM {
        constructor() {
        }

        public UVPCAM_CODUNI: string;
        public UVPCAM_CODAAM: string;
        public UVPCAM_CODCAR: string;


    }

    // class COTUVPAAM
    export class COTUVPAAM {
        constructor() {
        }

        public UVPAAM_MOSUAT: number;
        public UVPAAM_CANFIR: number;
        public UVPAAM_CODUNI: string;
        public UVPAAM_MOINAT: number;
        public UVPAAM_CODIGO: string;
